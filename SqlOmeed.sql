...
FROM 
    InventoryBalance ib
INNER JOIN Stores s ON ib.StoreID = s.ID
INNER JOIN Books b ON ib.ISBN13 = b.ISBN13;
...
FROM 
    BookAuthors ba
INNER JOIN Books b ON ba.ISBN13 = b.ISBN13
...
CREATE VIEW OrdersWithCustomerView AS
SELECT 
    o.OrderID,
...
FROM 
    OrderDetails od
INNER JOIN Books b ON od.ISBN13 = b.ISBN13;




CREATE VIEW InventorySummaryView AS
SELECT 
    b.ISBN13,
    b.Title,
